...
@WebAppConfiguration
 class UserControllerTest {
	   ...
	   void testGetUser() throws Exception {
		   ...
		   when(userService.getUser(1)).thenReturn((new User(null, "Ravi", "Ravi", "1234", "Ravi", null, null, null, null, null, null, null)));
	   ...
	   void testGetRolesOfUser() throws Exception {
		   ...
		   when(userService.getRolesOfUser(1)).thenReturn(Stream.of(new Role(1, "admin", "desc", null, null, null), new Role(2, "dev", "desc", null, null, null))
						.collect(Collectors.toList()));
